...
type BlogServiceClient interface {
	...
	DeleteBlogs(ctx context.Context, in *BlogId, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *blogServiceClient) DeleteBlogs(ctx context.Context, in *BlogId, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/blog.BlogService/DeleteBlogs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BlogServiceServer interface {
	...
	DeleteBlogs(context.Context, *BlogId) (*empty.Empty, error)
...
func (UnimplementedBlogServiceServer) DeleteBlogs(context.Context, *BlogId) (*empty.Empty, error) {
...
func _BlogService_DeleteBlogs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BlogId)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BlogServiceServer).DeleteBlogs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blog.BlogService/DeleteBlogs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlogServiceServer).DeleteBlogs(ctx, req.(*BlogId))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BlogService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _BlogService_DeleteBlogs_Handler,
		},
	},
